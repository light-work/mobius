...
import com.mobius.service.cal.CalSampleCoinService;
 ...
 */
@Singleton
public class CalSampleCoinStoreImpl implements CalSampleCoinStore {

    @Inject
    private CalSampleCoinService calSampleCoinService;
    ...
    @Override
    @ConnectManager
    public List<CalSampleCoin> getList(List<Selector> list) throws StoreException {
        try {
    ...
    public void save(CalSampleCoin calSampleCoin, Persistent persistent) throws StoreException {
        try {
            this.calSampleCoinService.save(calSampleCoin, persistent);
        } catch (HibernateException e) {
            Throwable throwable = e.getCause() != null ? e.getCause() : e;
            throw new StoreException(throwable.getLocalizedMessage(), e.fillInStackTrace());
        }
    ...
    @Override
    @ConnectManager
    public void save(List<CalSampleCoin> list, Persistent persistent) throws StoreException {
        try {
    ...
    public void delete(CalSampleCoin calSampleCoin) throws StoreException {
        try {
            this.calSampleCoinService.delete(calSampleCoin);
        } catch (HibernateException e) {
            Throwable throwable = e.getCause() != null ? e.getCause() : e;
            throw new StoreException(throwable.getLocalizedMessage(), e.fillInStackTrace());
        }
