...
public class DetailTaskForHuobiBtc implements Job {
            ...
            if (hsfServiceFactory != null) {
                try {
                    ...
                    if (sysIpServerStore != null) {
                        ...
                        if (sysIpServer != null) {
                            System.out.println("DailyTaskForHuobiBtc " + DateFormatUtil.getCurrentDateFormat(DateFormatUtil.YMDHMS_PATTERN)
                                    ...
                                    if (spotSymbolStore != null) {
                                        ...
                                        if (spotSymbolList != null && !spotSymbolList.isEmpty()) {
                                            for (SpotSymbol symbol : spotSymbolList) {
                                                FastCallForHuobi.callBtc(symbol, hsfServiceFactory, sysTrade, current);
                                            }
                                        }
                                    }
                                }
