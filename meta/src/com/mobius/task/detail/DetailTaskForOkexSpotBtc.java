...
public class DetailTaskForOkexSpotBtc implements Job {
     ...
     * </p>
     */
    public DetailTaskForOkexSpotBtc() {
    }
            ...
            if (hsfServiceFactory != null) {
                try {
                    ...
                    if (sysIpServerStore != null) {
                        ...
                        if (sysIpServer != null) {
                            System.out.println("DailyTaskForOKexSpotBtc " + DateFormatUtil.getCurrentDateFormat(DateFormatUtil.YMDHMS_PATTERN)
                                    ...
                                    if (spotSymbolStore != null) {
                                        ...
                                        if (spotSymbolList != null && !spotSymbolList.isEmpty()) {
                                            for (SpotSymbol symbol : spotSymbolList) {
                                                FastCallForOkex.callSpotBtc(symbol, hsfServiceFactory, sysTrade, current);
                                            }
                                        }
                                    }
                                }
